...
from detection_model.yolo.utils import LOGGER, ROOT, yaml_load
from detection_model.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from detection_model.yolo.utils.downloads import attempt_download_asset, is_url
from detection_model.yolo.utils.ops import xywh2xyxy
...
class AutoBackend(nn.Module):
    ...
    def __init__(self, weights='yolov8n.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if nn_module:
            ...
            from detection_model.nn.tasks import attempt_load_weights
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from detection_model.yolo.engine.exporter import export_formats
