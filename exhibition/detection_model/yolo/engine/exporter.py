...
from detection_model.nn.autobackend import check_class_names
from detection_model.nn.modules import Detect, Segment
from detection_model.nn.tasks import DetectionModel, SegmentationModel
from detection_model.yolo.cfg import get_cfg
from detection_model.yolo.data.dataloaders.stream_loaders import LoadImages
from detection_model.yolo.data.utils import IMAGENET_MEAN, IMAGENET_STD, check_det_dataset
from detection_model.yolo.utils import DEFAULT_CFG, LOGGER, __version__, callbacks, colorstr, get_default_args, yaml_save
from detection_model.yolo.utils.checks import check_imgsz, check_requirements, check_version, check_yaml
from detection_model.yolo.utils.files import file_size
from detection_model.yolo.utils.ops import Profile
from detection_model.yolo.utils.torch_utils import select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        self.metadata = {
            'description': f" {self.pretty_name} model trained on {self.model.args['data']}",
            'author': 'GY',
            'license': '',
            'version': __version__,
    ...
    def _export_coreml(self, prefix=colorstr('CoreML:')):
        ...
        class iOSModel(torch.nn.Module):
            # Wrap an YOLO model for iOS export
