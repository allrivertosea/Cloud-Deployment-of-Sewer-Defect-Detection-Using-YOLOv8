...
from detection_model.yolo.data.dataloaders.stream_loaders import (LOADERS, LoadImages, LoadPilAndNumpy, LoadScreenshots,
                                                                  LoadStreams, SourceTypes, autocast_list)
from detection_model.yolo.data.utils import IMG_FORMATS, VID_FORMATS
from detection_model.yolo.utils.checks import check_file
...
def check_source(source):
    ...
    if isinstance(source, (str, int, Path)):  # int for local usb carame
        ...
        raise Exception(
            "Unsupported type encountered! See docs")
