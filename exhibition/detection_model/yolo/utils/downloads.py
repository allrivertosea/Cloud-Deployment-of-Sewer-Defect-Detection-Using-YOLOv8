...
from detection_model.yolo.utils import LOGGER
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from detection_model.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='detection_model/assets', release='v0.0.0'):
    # Attempt file download from GitHub release assets if not found locally. release = 'latest', 'v6.2', etc.
    from detection_model.yolo.utils import SETTINGS
    from detection_model.yolo.utils.checks import check_yolov5u_filename
