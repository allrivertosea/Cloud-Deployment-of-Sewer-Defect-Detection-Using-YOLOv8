...
from detection_model.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, __version__
...
def select_device(device='', batch=0, newline=False):
    ...
    s = f"YOLOv{__version__} 🚀 Python-{platform.python_version()} torch-{torch.__version__} "
...
def strip_optimizer(f='best.pt', s=''):
    ...
    Usage:
        from detection_model.yolo.utils.torch_utils import strip_optimizer
        from pathlib import Path
