...
from detection_model.yolo.utils import (AUTOINSTALL, LOGGER, ROOT, USER_CONFIG_DIR, TryExcept, colorstr, downloads, emojis,
    ...
    if 'yolov3' in file or 'yolov5' in file and 'u' not in file:
        ...
        if file != original_file:
            LOGGER.info(f"PRO TIP 💡 Replace 'model={original_file}' with new 'model={file}'.\nYOLOv5 'u' models are "
                        ...
                        f"standard YOLOv5 models trained.\n")
    return file
...
def check_yolo(verbose=True):
    from detection_model.yolo.utils.torch_utils import select_device
