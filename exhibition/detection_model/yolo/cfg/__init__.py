...
from detection_model.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_PATH, LOGGER, ROOT, USER_CONFIG_DIR,
...
def entrypoint(debug=''):
    """
    This function is the detection_model package entrypoint, it's responsible for parsing the command line arguments passed
    to the package.
    ...
    if mode == 'predict' and 'source' not in overrides:
        overrides['source'] = DEFAULT_CFG.source or ROOT / "assets" if (ROOT / "assets").exists() \
            else "https://yolov8.com/images/bus.jpg"
